...
# This is crude parsing of output from setup.sh --list-machines
# Original expected output from setup.sh --list-machines:
...
#   ....
#
# This function ignores everything after the 'display' field
#
list_machines () {
