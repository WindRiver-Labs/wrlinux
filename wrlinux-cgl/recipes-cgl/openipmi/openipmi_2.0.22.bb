...
DEPENDS = "popt ncurses net-snmp openssl glib-2.0 swig-native"
...
inherit autotools-brokensep pkgconfig pythonnative perlnative systemd
...
FILES_${PN}-dbg += "${libdir}/perl/vendor_perl/*/auto/OpenIPMI/.debug \
